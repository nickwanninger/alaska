...
#include <alaska/RewriteStatepointsForGC.h>
...
static cl::opt<bool> PrintLiveSet("alaska-spp-print-liveset", cl::Hidden,
                                  cl::init(false));
static cl::opt<bool> PrintLiveSetSize("alaska-spp-print-liveset-size", cl::Hidden,
                                      cl::init(false));

// Print out the base pointers for debugging
static cl::opt<bool> PrintBasePointers("alaska-spp-print-base-pointers", cl::Hidden,
                                       cl::init(false));

// Cost threshold measuring when it is profitable to rematerialize value instead
// of relocating it
static cl::opt<unsigned>
RematerializationThreshold("alaska-spp-rematerialization-threshold", cl::Hidden,
                           cl::init(6));
...
static cl::opt<bool, true> ClobberNonLiveOverride("alaska-rs4gc-clobber-non-live",
                                                  cl::location(ClobberNonLive),
                                                  cl::Hidden);

static cl::opt<bool>
    AllowStatepointWithNoDeoptInfo("alaska-rs4gc-allow-statepoint-with-no-deopt-info",
...
PreservedAnalyses alaska::RewriteStatepointsForGC::run(Module &M,
...
bool alaska::RewriteStatepointsForGC::runOnFunction(Function &F, DominatorTree &DT,
                                            TargetTransformInfo &TTI,
                                            const TargetLibraryInfo &TLI) {
  using namespace llvm;
