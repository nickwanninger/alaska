...
int _obstack_begin(
    struct obstack *h, int size, int alignment, void *(*chunkfun)(long), void (*freefun)(void *)) {
...
int _obstack_begin_1(struct obstack *h, int size, int alignment, void *(*chunkfun)(void *, long),
...
void _obstack_newchunk(struct obstack *h, int length) {
 ...
 which does not do strict alignment for COPYING_UNITS.  */
  ...
  if (!h->maybe_empty_object &&
      (h->object_base == __PTR_ALIGN((char *)old_chunk, old_chunk->contents, h->alignment_mask))) {
