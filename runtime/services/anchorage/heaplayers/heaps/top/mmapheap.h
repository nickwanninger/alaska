...
namespace HL {
   ...
   public:
    ...
    static inline void *malloc(size_t sz) {
      ...
      char *ptr = (char *)VirtualAlloc(
          NULL, sz, MEM_RESERVE | MEM_COMMIT | MEM_TOP_DOWN, PAGE_EXECUTE_READWRITE);
#else
      char *ptr =
          (char *)VirtualAlloc(NULL, sz, MEM_RESERVE | MEM_COMMIT | MEM_TOP_DOWN, PAGE_READWRITE);
#endif
      return (void *)ptr;
    }
  ...
  class MmapHeap : public SizedMmapHeap {
   ...
   private:
    ...
    // class MyHeap : public LockedHeap<PosixLockType, FreelistHeap<BumpAlloc<16384,
    // SizedMmapHeap>>> {
