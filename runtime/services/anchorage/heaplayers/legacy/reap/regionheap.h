...
template <class Sbrk>
class LeaHeap2 : public Threshold<4096, DLSmallHeapType<DLBigHeapType<CoalesceableHeap<Sbrk> > > > {
};
...
class ReapTopHeap : public ChunkHeap<8192 - sizeof(typename AddHeader<NoHeap>::Header),
...
template <class MainStore>
class ReapBaseType : public ClearOptimizeHeap<AddHeader<ReapTopHeap<MainStore> >,
