...
// FAAASSSSS______________________000000000111111111222222222......
alaska_map_entry_t *alaska_map_drill_64(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 24) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 15) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 6) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
    lvl0[ind0] = (uint64_t)lvl1;
  }
  alaska_map_entry_t *lvl2 = (alaska_map_entry_t *)lvl1[ind1];
  if (unlikely(lvl2 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl2 = (alaska_map_entry_t *)alaska_alloc_map_frame(ind1, sizeof(alaska_map_entry_t), 512);
    lvl1[ind1] = (uint64_t)lvl2;
  }
  return &lvl2[ind2];
}

// FAAASSSSS_____________________000000000111111111222222222.......
alaska_map_entry_t *alaska_map_drill_128(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 25) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 16) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 7) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS____________________000000000111111111222222222........
alaska_map_entry_t *alaska_map_drill_256(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 26) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 17) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 8) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS___________________000000000111111111222222222.........
alaska_map_entry_t *alaska_map_drill_512(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 27) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 18) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 9) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS__________________000000000111111111222222222..........
alaska_map_entry_t *alaska_map_drill_1024(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 28) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 19) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 10) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS_________________000000000111111111222222222...........
alaska_map_entry_t *alaska_map_drill_2048(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 29) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 20) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 11) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS________________000000000111111111222222222............
alaska_map_entry_t *alaska_map_drill_4096(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 30) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 21) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 12) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS_______________000000000111111111222222222.............
alaska_map_entry_t *alaska_map_drill_8192(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 31) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 22) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 13) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS______________000000000111111111222222222..............
alaska_map_entry_t *alaska_map_drill_16384(uint64_t address, uint64_t *lvl0, int allocate) {
  uint64_t ind0 = (address >> 32) & 0b111111111; // index into uint64_t
  uint64_t ind1 = (address >> 23) & 0b111111111; // index into uint64_t
  uint64_t ind2 = (address >> 14) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS_____________000000000111111111222222222...............
alaska_map_entry_t *alaska_map_drill_32768(uint64_t address, uint64_t *lvl0, int allocate) {
  ...
  uint64_t ind2 = (address >> 15) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS____________000000000111111111222222222................
alaska_map_entry_t *alaska_map_drill_65536(uint64_t address, uint64_t *lvl0, int allocate) {
  ...
  uint64_t ind2 = (address >> 16) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS___________000000000111111111222222222.................
alaska_map_entry_t *alaska_map_drill_131072(uint64_t address, uint64_t *lvl0, int allocate) {
  ...
  uint64_t ind2 = (address >> 17) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS__________000000000111111111222222222..................
alaska_map_entry_t *alaska_map_drill_262144(uint64_t address, uint64_t *lvl0, int allocate) {
  ...
  uint64_t ind2 = (address >> 18) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
// FAAASSSSS_________000000000111111111222222222...................
alaska_map_entry_t *alaska_map_drill_524288(uint64_t address, uint64_t *lvl0, int allocate) {
  ...
  uint64_t ind2 = (address >> 19) & 0b111111111; // index into alaska_map_entry_t
  uint64_t *lvl1 = (uint64_t *)lvl0[ind0];
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (uint64_t *)alaska_alloc_map_frame(ind0, sizeof(uint64_t), 512);
...
alaska_map_entry_t *alaska_map_drill_536870912(uint64_t address, uint64_t *lvl0, int allocate) {
  ...
  if (unlikely(lvl1 == NULL)) { // slow: allocation
    if (allocate == 0) return NULL;
    lvl1 = (alaska_map_entry_t *)alaska_alloc_map_frame(ind0, sizeof(alaska_map_entry_t), 512);
    lvl0[ind0] = (uint64_t)lvl1;
  }
  return &lvl1[ind1];
}
