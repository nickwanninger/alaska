...
class Kconfig(object):
    ...
    def _init(self, filename, warn, warn_to_stderr, encoding):
        ...
        self.config_prefix = "ALASKA_" # os.getenv("CONFIG_", "CONFIG_")
    ...
    def write_config(self, filename=None, header=None, save_old=True,
        ...
        self.write_autoconf('runtime/include/alaska/autoconf.h')
        # self.write_autoconf('compiler/include/_config.h')
